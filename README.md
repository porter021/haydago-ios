...
* 书虫 提供了2种方式的API：`Web方式`和`Content Provider方式`。您可以在[这里](api.md)根据需要自行调用。 
...
##### 免责声明
书源规则等套用[开源阅读](https://github.com/mgz0227/legado-Harmony)，ios原生编程，学习之用
...
<img src="png/audiobook.png" width="270">    <img src="png/find.png" width="270">
